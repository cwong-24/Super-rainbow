        ...
        if(this.isLive()) {
            ...
            try{
                if(this.getType() == "solidBlock")
                    img = ImageIO.read(new File("resources/image/Block_solid.gif"));
                if(this.getType() == "lifeBlock")
                    img = ImageIO.read(new File("resources/image/Block_life.gif"));
                if(this.getType() == "purpleBlock")
                    img = ImageIO.read(new File("resources/image/Block1.gif"));
                if(this.getType() == "yellowBlock")
                    img = ImageIO.read(new File("resources/image/Block2.gif"));
                if(this.getType() == "redBlock")
                    img = ImageIO.read(new File("resources/image/Block3.gif"));
                if(this.getType() == "greenBlock")
                    img = ImageIO.read(new File("resources/image/Block4.gif"));
                if(this.getType() == "cyanBlock")
                    img = ImageIO.read(new File("resources/image/Block5.gif"));
                if(this.getType() == "blueBlock")
                    img = ImageIO.read(new File("resources/image/Block6.gif"));
                if(this.getType() == "grayBlock")
                    img = ImageIO.read(new File("resources/image/Block7.gif"));
                if(this.getType() == "splitBlock")
                    img = ImageIO.read(new File("resources/image/Block_split.gif"));
